...
Protxml_schema_defaults = {
  ...
  'floatlists' => Set.new,
  'floats' => Set.new([
    ['ASAPRatio', 'heavy2light_ratio_mean'],
  ...
  'intlists' => Set.new,
  'ints' => Set.new([
    ['ASAPRatio', 'ratio_number_peptides'],
    ['ASAP_Peak', 'datanum'],
    ['ASAP_Seq', 'datanum'],
...
Mzxml_schema_defaults = {
  ...
  'floatlists' => Set.new,
  'floats' => Set.new([
    ['dataProcessing', 'intensityCutoff'],
...
Pepxml_schema_defaults = {
  ...
  'charlists' => Set.new,
  'lists' => Set.new([
    'point', 'aminoacid_modification', 'msms_run_summary',
